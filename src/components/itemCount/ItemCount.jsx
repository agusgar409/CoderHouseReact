			...
			<div className='col-lg-6'>
				<div className='row'>
					<div className='col-lg-4 align-self-center'>
						<button onClick={onDecrement} type="button" className="btn btn-outline-primary">-</button>
					</div>
					<div className='col-lg-2 align-self-center'>
						<p className='text-center textColor'>{valueCounter}</p>
					</div>
					<div className='col-lg-4 align-self-center'>
						<button onClick={onPlus} type="button" className="btn btn-outline-primary">+</button>
					</div>
				</div>
			</div>
			<div className='col-lg-6 align-self-center'>
				<button onClick={() => addToCart(valueCounter)} type="button" className="btn btn-outline-primary">Add to cart</button>
			</div>
		</div>
	)
}
